error id: file://<WORKSPACE>/src/test/java/com/example/utils/RestClient.java:_empty_/`<any>`#queryParams#
file://<WORKSPACE>/src/test/java/com/example/utils/RestClient.java
empty definition using pc, found symbol in pc: _empty_/`<any>`#queryParams#
...
public class RestClient {
    ...
    public static Response get(String path, Object queryParams) {
        ...
        Response response = given()
                .spec(BaseTest.requestSpec)
                .quer@@yParams(queryParams.toString())
                .when()
                .get(path)
                .then()
                .extract()
