error id: file://<WORKSPACE>/src/test/java/com/example/utils/RestClient.java:java/lang/Object#toString().
file://<WORKSPACE>/src/test/java/com/example/utils/RestClient.java
empty definition using pc, found symbol in pc: java/lang/Object#toString().
